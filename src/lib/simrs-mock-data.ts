...
export const mockShiftSwapRequests: ShiftSwapRequest[] = [
  ...
  },
  {
    ...
    requester_id: 'N-003',
    requester_role: 'perawat',
    requester_name: 'Ns. Andi',
    department_name: 'ICU',
    current_date: '2026-07-10',
    current_shift: 'Sore',
    requested_date: '2026-07-11',
    requested_shift: 'Pagi',
    reason: 'Menemani anak sakit',
    urgency: 'Tinggi',
    status: 'Menunggu Persetujuan',
  ...
  },
  {
    ...
    updated_at: '2026-07-04 11:45:00',
  },
  {
    request_id: 'SWAP-005',
    requester_id: 'D-004',
    requester_role: 'dokter',
    requester_name: 'dr. Joko',
    department_name: 'Poli Penyakit Dalam',
    current_date: '2026-07-15',
    current_shift: 'Pagi',
    requested_date: '2026-07-16',
    requested_shift: 'Pagi',
    reason: 'Checkup kesehatan rutin',
    urgency: 'Rendah',
    status: 'Menunggu Persetujuan',
    ai_suitability_score: 78,
    ai_recommendation: 'Review',
    ai_constraint_message: 'Rasio staf perawat vs dokter tidak seimbang di shift tujuan.',
