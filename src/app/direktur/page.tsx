...
const rekomendasiStrategis = [
  {
    ...
    prioritas: "Tinggi",
    rekomendasi:
      "Terapkan shift maksimal 8 jam dengan rotasi maju dan jeda 24 jam setelah shift malam untuk menurunkan risiko burnout 86%.",
  },
  {
    unit: "ICU / NICU / PICU",
    prioritas: "Tinggi",
    rekomendasi:
      "Batasi lembur dan hindari double-shift. Jaga rasio perawat-pasien 1:1 atau 1:2 untuk keselamatan pasien kritis.",
  },
  {
    unit: "Kamar Operasi",
    prioritas: "Sedang",
    rekomendasi:
      "Seimbangkan jadwal operasi elektif dan berikan kompensasi waktu istirahat setelah operasi berdurasi panjang.",
  },
  {
    unit: "Ruang Bersalin",
    prioritas: "Sedang",
...
const faktorRisikoIGD = [
  {
    faktor: "Lonjakan pasien malam",
    dampak: "Kelelahan fisik dan mental meningkat",
    rekomendasi: "Tambahkan buffer staf pada shift malam",
  },
  {
    faktor: "Shift beruntun",
    dampak: "Risiko fatigue meningkat",
    rekomendasi: "Hindari penjadwalan shift malam berturut-turut",
  },
  {
    faktor: "Kondisi darurat tidak terprediksi",
    dampak: "Stres kerja meningkat",
    rekomendasi: "Gunakan prediksi beban pasien berbasis historis",
  },
  {
    faktor: "Waktu istirahat pendek",
    dampak: "Pemulihan tidak optimal",
    rekomendasi: "Terapkan jeda 12–24 jam setelah shift malam",
  },
];
...
const staffMonitoring = [
  {
    ...
    skor: 88,
    risiko: "Kritis",
    rekomendasi: "Jeda 24 jam dan hindari shift malam berikutnya",
  },
  {
    ...
    skor: 84,
    risiko: "Tinggi",
    rekomendasi: "Batasi lembur dan rotasi ke shift sore",
  },
  {
    ...
    skor: 79,
    risiko: "Tinggi",
    rekomendasi: "Kurangi jadwal operasi panjang berturut-turut",
  },
  {
    nama: "Ns. Siti Aisyah",
    profesi: "Perawat",
    ...
    skor: 76,
    risiko: "Sedang",
    rekomendasi: "Atur ulang jadwal on-call",
  },
  {
    nama: "Ns. Dwi Santoso",
    profesi: "Perawat",
    ...
    skor: 73,
    risiko: "Sedang",
    rekomendasi: "Rekomendasikan rotasi bangsal periodik",
  },
];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 py-6 space-y-6">
        ...
        <div className="kpi-grid">
          ...
          <div
            ...
            role="button"
            tabIndex={0}
            onKeyDown={(e) => e.key === "Enter" && setActiveModal("unit")}
          >
            <KPICard
          ...
          <div
            onClick={() => setActiveModal("staf")}
            className="cursor-pointer transition-transform duration-200 hover:scale-[1.02] h-full [&>div]:h-full"
            role="button"
            tabIndex={0}
            onKeyDown={(e) => e.key === "Enter" && setActiveModal("staf")}
          >
            <KPICard
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <ResponsiveChartCard
            title="Tren Risiko Burnout Mingguan"
            subtitle="Rata-rata skor burnout seluruh unit prioritas per minggu"
            height={240}
          >
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart
                data={trendBurnoutData}
                margin={{ top: 10, right: 10, left: 0, bottom: 0 }}
              >
                <defs>
                  <linearGradient
                    id="colorBurnoutTrend"
                    x1="0"
                    y1="0"
                    x2="0"
                    y2="1"
                ...
                <Area
                  ...
                  strokeWidth={3}
                  fillOpacity={1}
                  fill="url(#colorBurnoutTrend)"
                  activeDot={{ r: 6, strokeWidth: 0, fill: "#c62828" }}
                  name="Rata-rata Burnout"
                />
              </AreaChart>
            </ResponsiveContainer>
          </ResponsiveChartCard>
          ...
          <div className="clay-card-sm p-5 sm:p-6">
            <div className="mb-4">
              ...
              <p className="text-xs text-outline mt-0.5">
                Insight otomatis dari tiga AI Core Engine
              </p>
            </div>
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border-l-4 ${
                    rec.prioritas === "Tinggi"
                      ? "bg-[#fce8e8] border-l-[#e57373]"
                      : rec.prioritas === "Sedang"
                        ? "bg-[#fff8e1] border-l-[#ffb74d]"
        ...
        <div className="clay-card p-5 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div
              className="p-4 rounded-2xl text-center bg-[#fff8e1]"
              style={{
                boxShadow:
        ...
        <p className="text-xs text-outline text-center py-4">
          Dashboard eksekutif — seluruh data berasal dari AI Core Engine
          simulation untuk pemantauan burnout tenaga medis.
        </p>
      </main>
                ...
                <>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-on-surface-variant">
                        Risiko burnout gabungan dokter dan perawat pada 5 unit
                        prioritas.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={u}
                        className="clay-badge bg-surface-container text-on-surface-variant border border-surface-container-high text-xs"
                      >
                        {u}
                      </span>
                    ))}
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-on-surface mb-3">
                      Kontribusi Risiko Burnout per Unit
                    </h4>
                    <div
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Bar
                            ...
                            name="Risiko Burnout (%)"
                          >
                            {kontribusiBurnoutData.map((_, i) => (
                              <Cell key={i} fill={burnoutBarColors[i]} />
                            ))}
                          </Bar>
                        </BarChart>
                      </ResponsiveContainer>
                  ...
                  <div className="p-4 rounded-xl bg-[#fff8e1] border-l-4 border-l-[#ffb74d]">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
                        Rata-rata risiko burnout berada pada kategori
                        sedang-tinggi. IGD dan ICU menjadi penyumbang risiko
                        terbesar karena intensitas pasien tinggi, tekanan klinis
                        berat, serta frekuensi shift malam yang lebih dominan.
                      </p>
                    </div>
                  </div>
                </>
                ...
                <>
                  ...
                  <div className="p-4 rounded-xl bg-[#fce8e8] border-l-4 border-l-[#e57373]">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
                        IGD menjadi unit dengan risiko tertinggi karena
                        kombinasi beban pasien tinggi, kondisi darurat tidak
                        terprediksi, dan intensitas kerja pada shift malam.
                      </p>
                    </div>
                  </div>
                </>
                ...
                <>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-on-surface-variant">
                        Staf dengan skor kelelahan tinggi berdasarkan pola
                        absensi, lembur, shift malam, dan hasil asesmen burnout.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-on-surface mb-3">
                      Tabel Monitoring Staf
                    </h4>
                    <div className="space-y-3">
                      {staffMonitoring.map((s) => (
                        <div
                          key={s.nama}
                          className="p-4 rounded-xl border border-surface-container-high bg-surface-container-low"
                        >
                          ...
                          <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 mb-3">
                            <div className="flex items-center gap-2">
                              ...
                              <StatusBadge
                                status={
                                  s.profesi === "Dokter" ? "dokter" : "perawat"
                                }
                              />
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={`text-sm font-bold ${s.skor >= 80 ? "text-[#c62828]" : s.skor >= 70 ? "text-[#e65100]" : "text-[#f57f17]"}`}
                              >
                                {s.skor}
                              </span>
                            </div>
                          ...
                          <div className="pt-2 border-t border-surface-container">
                            <p className="text-[10px] text-outline mb-0.5">
                              Rekomendasi AI:
                            </p>
                            <p className="text-xs text-on-surface-variant">
                              {s.rekomendasi}
                  ...
                  <div className="p-4 rounded-xl bg-[#fce8e8] border-l-4 border-l-[#e57373]">
                    <div className="flex items-start gap-2">
                      <Lightbulb className="w-4 h-4 text-[#e57373] mt-0.5 shrink-0" />
                      <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
                        Sebanyak 28 staf membutuhkan penyesuaian jadwal atau
                        waktu pemulihan karena memiliki akumulasi beban kerja
                        tinggi, terutama pada unit IGD, ICU, dan Kamar Operasi.
                      </p>
                    </div>
                  </div>
                </>
