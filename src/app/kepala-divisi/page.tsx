    ...
    <div className={`clay-card p-5 border-t-4 ${getBorderTopColor(req.status)}`}>
      ...
      {isPending && (
        <div className="mt-4 pt-4 border-t border-surface-container-high">
          <textarea
            placeholder="Catatan kepala divisi (opsional)..."
            value={kadivNote}
      ...
      <div className="min-h-screen bg-surface-container flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-on-surface-variant mt-1">Kepala Divisi Dashboard</p>
          </div>
          ...
          <div className="clay-card p-6 space-y-4">
            ...
            <p className="text-[10px] text-center text-outline mt-4">
              *Halaman ini untuk Kepala Divisi. Data mock akan diload.
            </p>
          </div>
      ...
      >
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/80">Kepala Divisi • Approval Tier 1</p>
          </div>
        </div>
      </header>
